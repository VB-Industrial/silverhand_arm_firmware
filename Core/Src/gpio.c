...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, STEP_Pin|DIR_Pin|SD_MODE_Pin, GPIO_PIN_RESET);

  HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin|SPI_MODE_Pin|SPI3_CS_Pin, GPIO_PIN_SET);
