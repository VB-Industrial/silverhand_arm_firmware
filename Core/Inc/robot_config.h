...
static const uint64_t SR_FIRMWARE_VERSION_TRIAL = 28U;
...
static const robot_joint_profile kRobotJointProfiles[] = {
    ...
    {6U, 26U, 100U, 1126U, 1136U, 1001U, 7509U, 14U, 0.3F, 5, 1, 3, 1, 2458010U, 19.203208F, 2.5F, 0U, 0.8F, 0.2F, 0.95F, 0.05F, 0.1F, 1.0F, 1.0F, true, true, 1, -2.82F, 2.84F, 0.076699019F},
};
